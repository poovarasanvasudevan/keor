...
class UserInput extends Component {
  ...
  _renderSendOrFileIcon() {
    if (this.state.inputHasText) {
      return (
        <div className={[css["sc-user-input--button"]]}>
  ...
  render() {
    ...
    return (
      <form className={ [ css['sc-user-input'], css["`${(inputActive ? 'active' : '')}`"]].join(' ')}>
        <div
          role="button"
          tabIndex="0"
          ...
          className={css["sc-user-input--text"]}
        >
        </div>
        <div className={css["sc-user-input--buttons"]}>
          <div className={css["sc-user-input--button"]}></div>
          <div className={css["sc-user-input--button"]}>
