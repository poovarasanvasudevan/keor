...
<div className ={ css["sc-user-input--picker-wrapper"]}>
  {tooltip}
  <button id="sc-emoji-picker-button" className={css["sc-user-input--emoji-icon-wrapper"]} onClick={onClick}>
    <svg
      className={[css['sc-user-input--emoji-icon'],css[`${(isActive ? 'active' : '')}`]]}
      version="1.1"
